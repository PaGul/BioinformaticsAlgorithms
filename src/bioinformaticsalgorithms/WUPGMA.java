...
public class WUPGMA {
    ...
    public void run() {
        ...
        while (!matrix.isEmpty()) {
            ...
            for (Node c : currNodes) {
                ...
                double cAndNewNode = countDist(matrix, min.first.letter, min.second.letter, c.letter);
    ...
    public double countDist(PriorityQueue<Value> matrix, String first, String second, String c) {
        double fComp = 0;
        double sComp = 0;
